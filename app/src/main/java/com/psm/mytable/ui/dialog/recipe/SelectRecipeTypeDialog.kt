...
class SelectRecipeTypeDialog: TouchCancelDialogFragment() {

    private lateinit var viewDataBinding: DialogSelectRecipeTypeBinding
    ...
    companion object {
        ...
        fun newInstance(requestKey: String? = null): DialogFragment {
            val fragment = SelectRecipeTypeDialog()
            val args = Bundle()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        viewDataBinding = DialogSelectRecipeTypeBinding.inflate(inflater, container, false)
    ...
    fun setupEvent(){
        ...
        viewModel.showRecipeEvent.observe(viewLifecycleOwner, EventObserver{type->
            requestKey?.let{requestKey ->
                setFragmentResult(requestKey, DialogUtils.clickRecipeType(type))
                dismiss()
            }
        })
    }
