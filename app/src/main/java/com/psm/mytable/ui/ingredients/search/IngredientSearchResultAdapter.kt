...
class IngredientSearchResultAdapter(private val viewModel: IngredientsViewModel) : ListAdapter<IngredientsItemData, IngredientSearchResultAdapter.ViewHolder>(
